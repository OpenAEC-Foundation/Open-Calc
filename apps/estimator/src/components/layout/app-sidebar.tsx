...
// Edition configuration - Estimator Edition
const CURRENT_EDITION = "ESTIMATOR";
    ...
    <Sidebar>
      <SidebarHeader className="border-b px-4 py-4">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <span className="text-lg font-bold bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent">OpenCalc</span>
            <p className="text-[10px] text-muted-foreground -mt-0.5">Estimator Pro</p>
          </div>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t p-3">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild className="w-full h-auto py-2 hover:bg-amber-50/80">
              <Link href="/settings">
